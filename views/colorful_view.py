class ColorfulView:
    ...
    colors_dict = {'green txt': '\x1b[1;32;40m', 'yellow txt': '\x1b[1;33;40m',
                   'red txt': '\x1b[0;31;40m', 'blue txt': '\x1b[4;34;40m',
                   'white txt': '\x1b[1;37;40m', 'ascii': '\x1b[1;35;40m'}
    ...
    def format_string_to_white(example_string=''):
        formated_string = '{}{}{}'.format(ColorfulView.colors_dict['white txt'], example_string, '\x1b[0m')
        return formated_string
